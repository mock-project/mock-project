...
public class Route implements Serializable {
	...
	public String toString() {
		return "Route [routesId=" + routesId + ", busId=" + busId + ", distance=" + distance + ", endDate=" + endDate
				+ ", price=" + price + ", startDate=" + startDate + ", place1=" + place1 + ", place2=" + place2
				+ ", seatJunctions=" + seatJunctions + ", tickets=" + tickets + ", departture=" + departture + "]";
	}
